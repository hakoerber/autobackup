...
class Parser(object):
    ...
    def parse(self):
        ...
        for line in self.text.split('\n'):
            ...
            if not line:
                continue
            if any([(line[0], line[-1]) == pair 
                    for pair in self.section_pairs]):
                current_section = line
                self.structure[line] = {}
                continue
            elif any([(line[0], line[-1]) == pair 
